...
function Card({
  ...
  return (
    <div
      data-slot="card"
      data-size={size}
      className={cn("ring-foreground/8 bg-card text-card-foreground gap-0 overflow-hidden rounded-3xl py-0 text-sm ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-0 data-[size=sm]:py-0 *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl group/card flex flex-col", className)}
      {...props}
    />
  )
}
